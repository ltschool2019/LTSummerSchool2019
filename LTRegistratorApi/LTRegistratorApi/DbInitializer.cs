    ...
    public class DbInitializer
    {
        public static void Initialize(ApplicationContext context, UserManager<ApplicationUser> userManager)
        {
            ...
            if (!context.Employee.Any())
            {
                 ...
                 context.Employee.Add(new Employee() { User = "Eve" });
            ...
            {
                context.Project.Add(new Project() { Name = "A", ManagerId = 1});
                context.Project.Add(new Project() { Name = "B", ManagerId = 1});
                context.Project.Add(new Project() { Name = "С", ManagerId = 3});
                context.SaveChanges();
            }
